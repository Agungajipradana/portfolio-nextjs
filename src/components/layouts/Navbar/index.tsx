...
const Navbar = () => {
  return (
    <nav>
      <div className=" hidden lg:flex lg:justify-between lg:text-slate-500 lg:pt-5 lg:box-border lg:border-4-none lg:items-center lg:pb-10 lg:mx-12 ">
        ...
        <div className="lg:flex lg:space-x-2 lg:mr-2  lg:items-center">
